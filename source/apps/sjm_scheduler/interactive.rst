...
======================================================
SJM supports two approaches for a user to launch a scheduled task interactively. Each method will launch the task on a new thread not monitored by the 
...
SAS Macro
------------------------------------------------
User can call a SAS macro to launch a job from within a SAS program file. The parameter IN_JOB accepts the value of *Description* recorded for the job recorded 
