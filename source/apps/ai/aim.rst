...
Analysis Index Manager (AIM) Version 5
============================================
...
The application is invoked from a SAS macro, mcr_spi_run_aim, from a calling program under the analysis level utilities subfolder (typically [analysis]\\utilities\\ai\\pgms). There is 
not content menu available in File Explorer to launch v5, as there was for v4.
