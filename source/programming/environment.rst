...
+++++++++++++++++++++++++++++
Static macro variables are defined in the ALM v3 Macro Variables View. To see the currrent list, open ALM macro variables view. Contact SPI for assistance with modification of the department macro variables. 
...
AIPATH                    Path to the calling program-level [path]\\utilities\\ai folder
AIPATH_PRODUCT            Path to the product-level ai folder for Analysis Index, QC Index, and associated reference tables
AIPATH_PROTOCOL           Path to the protocol-level ai folder for Analysis Index, QC Index, and associated reference tables
AIPATH_SPI                Path to the department-level ai folder for Analysis Index, QC Index, and associated reference tables
...
.. list-table:: 
  ...
  * - Libref
    - AI
    - Analysis Index, QC Index, and associated reference tables
    - #. &root.\\&draft.\\utilities\\ai
      #. O:\\projects\\&product.\\&project.\\utilities\\ai
      #. O:\\projects\\&product.\\utilities\\ai
      #. O:\\projects\\utilities\\ai
    - #. AIPATH 
      #. AIPATH_PROTOCOL
      #. AIPATH_PRODUCT
      #. AIPATH_SPI      
